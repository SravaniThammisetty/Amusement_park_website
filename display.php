...
?>
			...
			<tr>
				<th><?php echo $res['staff_id'] ?></th>
				<th><?php echo $res['name'] ?></th>
				<th><?php echo $res['age'] ?></th>
				<th><?php echo $res['salary'] ?></th>
				<th><?php echo $res['department'] ?></th>
				<th><?php echo $res['date_of-birth'] ?></th>
				<th><?php echo $res['date_of_join'] ?></th>
				<th><a  href="update.php?id=<?php echo $res['staff_id']; ?>" class="text-white"><button class="btn btn-success">View</button></a></th>
			</tr>
<?php }
?>
