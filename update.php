...
$age = $_POST['age'];
$salary = $_POST['salary'];
$qualification = ucfirst($_POST['department']);
...
$q="select * from employee where staff_id = $id";
...
<div class="col-lg-6 m-auto">
	...
	<form method="post">
        ...
        title="this field accepts only numbers"><br>
			...
			value="<?php echo $res['date_of-birth']; ?>" placeholder="date-month-year" required><br>
...
if(isset($_POST['done']))
{
$q2="update employee set staff_id = $id , name = '$name' , age = $age , date_of-birth = '$dob' , date_of_join = '$date_of_join' , salary = $salary , department = '$qualification' , where staff_id = $id";
...
$_SESSION['id'] = $id;
	header("location:attendance1.php?id=$id");
